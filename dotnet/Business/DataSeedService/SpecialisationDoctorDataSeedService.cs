...
{
    public static SpecialisationDoctor Specialisation_Doctor0 = new()
    {
    ...
    public static SpecialisationDoctor Specialisation_Doctor1 = new()
    {
    ...
    public static SpecialisationDoctor Specialisation_Doctor2 = new()
    {
    ...
    public static SpecialisationDoctor Specialisation_Doctor3 = new()
    {
    ...
    public static SpecialisationDoctor Specialisation_Doctor4 = new()
    {
    ...
    {
        await repository.CreateOrUpdateRangeAsync(new List<SpecialisationDoctor>
        {
            Specialisation_Doctor0, Specialisation_Doctor1, Specialisation_Doctor2, Specialisation_Doctor3,
            Specialisation_Doctor4
        });
    }
}