...
namespace Business.DataSeedService
{
    public class HospitalDoctorDataSeedService : IDataSeedService, IHospitalDoctorDataSeedService
    {
        ...
        {
            await repository.CreateOrUpdateRangeAsync(new List<HospitalDoctor> { Hospital_Doctor0, Hospital_Doctor1, Hospital_Doctor2, Hospital_Doctor3, Hospital_Doctor4 });
        }
    }
}