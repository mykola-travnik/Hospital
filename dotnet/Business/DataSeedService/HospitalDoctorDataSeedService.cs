...
{
    public static HospitalDoctor Hospital_Doctor0 = new()
    {
    ...
    public static HospitalDoctor Hospital_Doctor1 = new()
    {
    ...
    public static HospitalDoctor Hospital_Doctor2 = new()
    {
    ...
    public static HospitalDoctor Hospital_Doctor3 = new()
    {
    ...
    public static HospitalDoctor Hospital_Doctor4 = new()
    {
    ...
    {
        await repository.CreateOrUpdateRangeAsync(new List<HospitalDoctor>
            { Hospital_Doctor0, Hospital_Doctor1, Hospital_Doctor2, Hospital_Doctor3, Hospital_Doctor4 });
    }
}