...
{
    public static Country Country0 = new()
    {
    ...
    public static Country Country1 = new()
    {
    ...
    public static Country Country2 = new()
    {
    ...
    public static Country Country3 = new()
    {
    ...
    public static Country Country4 = new()
    {
    ...
    {
        await repository.CreateOrUpdateRangeAsync(
            new List<Country> { Country0, Country1, Country2, Country3, Country4 });
    }
}