...
{
    public static Hospital Hospital0 = new()
    {
        ...
        CityId = CityDataSeedService.City0.Id,
        Address = "Strada Karl Liebknecht 1/2, Tiraspol",
        Phone = "+373(533)61818",
        Photo = ""
    };

    public static Hospital Hospital1 = new()
    {
    ...
    public static Hospital Hospital2 = new()
    {
    ...
    public static Hospital Hospital3 = new()
    {
    ...
    public static Hospital Hospital4 = new()
    {
    ...
    {
        await repository.CreateOrUpdateRangeAsync(new List<Hospital>
            { Hospital0, Hospital1, Hospital2, Hospital3, Hospital4 });
    }
}