...
{
    public static Specialisation Specialisation0 = new()
    {
    ...
    public static Specialisation Specialisation1 = new()
    {
    ...
    public static Specialisation Specialisation2 = new()
    {
    ...
    public static Specialisation Specialisation3 = new()
    {
    ...
    public static Specialisation Specialisation4 = new()
    {
    ...
    {
        await repository.CreateOrUpdateRangeAsync(new List<Specialisation>
            { Specialisation0, Specialisation1, Specialisation2, Specialisation3, Specialisation4 });
    }
}