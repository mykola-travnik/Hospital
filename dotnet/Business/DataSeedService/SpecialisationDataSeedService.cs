...
{
    public class SpecialisationDataSeedService : AbstractDataSeedService, IDataSeedService, ISpecialisationDataSeedService
    {
        ...
        public static Specialisation Specialisation5 = new Specialisation()
        {
        ...
        {
            await repository.SeedData(new List<Specialisation> { Specialisation1, Specialisation2, Specialisation3, Specialisation4, Specialisation5 });
        }
    }
}